...
public class DisplayAnxiousFragment extends Fragment {
    public static Context mContext;
    public static int mscore;
    public static DisplayAnxiousFragment newInstance(Context context, int score) {
    	mContext = context;
    	mscore = score;
    	DisplayAnxiousFragment fragment = new DisplayAnxiousFragment();
        return fragment;
    }
