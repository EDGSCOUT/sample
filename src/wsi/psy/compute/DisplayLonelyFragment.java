...
public class DisplayLonelyFragment extends Fragment {
    public static Context mContext;
    public static int mscore;
    public static DisplayLonelyFragment newInstance(Context context, int score) {
    	mContext = context;
    	mscore = score;
    	DisplayLonelyFragment fragment = new DisplayLonelyFragment();
        return fragment;
    }
