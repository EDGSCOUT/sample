...
public class GloomyFragment extends Fragment {
    private static final String KEY_CONTENT = "TestFragment:Content";
    public static  int num;
    public static Context mContext;
    public List<Double> list;
    public List<String[]> timeList;
    public static GloomyFragment newInstance(Context context, int position) {
    	num = position;
    	mContext = context;
    	GloomyFragment fragment = new GloomyFragment();
        return fragment;
    }
