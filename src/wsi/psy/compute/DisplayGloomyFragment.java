...
public class DisplayGloomyFragment extends Fragment {
    public static Context mContext;
    public static int mscore;
    public static DisplayGloomyFragment newInstance(Context context, int score) {
    	mContext = context;
    	mscore = score;
    	DisplayGloomyFragment fragment = new DisplayGloomyFragment();
        return fragment;
    }
...
//        layout.setBackgroundResource(getResources().getDrawable(R.drawable.bg_main));
        return layout;
    }
